        ...
        <div class="flex justify-between w-full ">
            ...
            <div class="flex space-x-3 items-center">
                ...
                <a href=" {{ route('blog.trash') }} "
                    class="text-white bg-gradient-to-r from-yellow-500 via-yellow-600 to-yellow-700 hover:bg-gradient-to-br focus:ring focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 shadow-lg shadow-yellow-500/50 dark:shadow-lg dark:shadow-yellow-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 justify-items-center ">Restore</a>
                </div>
        </div>
        @if (session('success'))
